...
export type StartupTypeCard = Omit<Startup,"author"> & { author?: Author };//use Startup type without the property of author,removing author and adding a expanded author object
